...
impl Sumeragi {
    ...
    fn update_params(&mut self, state_block: &StateBlock<'_>) {
        self.block_time = state_block.parameters().block_time();
        self.commit_time = state_block.parameters().commit_time();
        self.max_txs_in_block = state_block.parameters().max_transactions_in_block.get() as usize;
    }
